...
export const webMcpTools: readonly WebMcpTool[] = [
  ...
  },
  {
    ...
    description:
      'Maps information the applicant supplied into up to fifteen schema-valid proposals. Proposals are displayed for individual human confirmation and never alter stored answers by themselves. The applicant declaration is unavailable to agents.',
    inputSchema: {
      type: 'object',
      properties: {
        proposals: {
